...
* $P$ : $S \times A \to \mathcal{P}(S)$ is the transition probability function, with $P(s'\verts,a)$ being the probability of transitioning into state s' if you start in state s and take action a,
